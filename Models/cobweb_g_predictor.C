...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::sendParameters(int& amount,qreal** parameters)
{
    if( *parameters )
	delete *parameters;
    amount=L+7;
...
/*                                                                            */
/******************************************************************************/
qreal* cobweb_g_predictor::setLabels(char *name)
{
...
/*                                                                            */
/******************************************************************************/
qreal* cobweb_g_predictor::sendModelVar()
{
    return pp;
}
/******************************************************************************/
...
{
    //Log::log() << "cobweb_g_predictor sendStateSpace";
    if( *stateSpace )
	delete *stateSpace;
...
/*                                                                            */
/******************************************************************************/
qreal cobweb_g_predictor::hoch(qreal &x,int &i)
{
    qreal count=1.0;
	for (int k=i;k>0;k--)
		count*=x;
...
/*                                                                            */
/******************************************************************************/
qreal cobweb_g_predictor::fFunction(qreal &x)
{
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::dynamics(qreal &a)
{
	for (int i=1;i<=L;i++) 
		pp[L+1-i]=pp[L-i];
	pp[0]=fFunction(a);				
