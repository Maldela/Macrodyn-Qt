/******************************************************************************/
/*                                                                            */
/* Module name:  cobweb_g_predictor.C                                         */
/* Contents:     Member functions of the class cobweb_g_predictor             */
/*                Standardversion of Cars Hommes                              */
/* Modified:     28.01.1997 old name was toni.C (Marc Mueller)                */
...
/******************************************************************************/
/*                                                                            */
/* Class name:      cobweb_g_predictor                                        */
/* Member function: cobweb_g_predictor                                        */
/* Purpose:         constructor                                               */
/* Last modified:   30.01.1997 (Marc Mueller)                                 */
/*                                                                            */
/******************************************************************************/
cobweb_g_predictor::cobweb_g_predictor() : baseModel(1)
{
    pp0=NULL;
    pp=NULL;
    vv=NULL;
...
/*                                                                            */
/******************************************************************************/
cobweb_g_predictor::~cobweb_g_predictor()
{
    if( pp0 )
	delete [] pp0;
    if( pp )
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::initialize()
{
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::loadParamset(ifstream& inputFile)
{
	...
	delete [] pp0;
        pp0 = new real[L+1];
    if( !pp0 )
	fatalError("cobweb_g_predictor::loadParamset","Can't create initprice vector");
	...
	delete [] pp;
        pp = new real[L+1];
    if( !pp )
	fatalError("cobweb_g_predictor::loadParamset","Can't create price vector");
    if( vv )
	delete [] vv;
        vv = new real[L+1];
    if( !vv )
	fatalError("cobweb_g_predictor::loadParamset","Can't create weight vector");
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::saveParamset(ofstream& outputFile)
{
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::saveParamsetWithNames(ofstream& outputFile)
{
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::sendParameters(int& amount,real** parameters)
{
    if( *parameters )
	delete *parameters;
    amount=L+7;
    *parameters=new real[amount];
    if( !(*parameters) )
	fatalError("cobweb_g_predictor::sendParameters",
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::receiveParameters(const real* parameters)
{
    a=parameters[0];
    b=parameters[1];
    alpha=parameters[2];
...
/*                                                                            */
/******************************************************************************/
real* cobweb_g_predictor::setLabels(char *name)
{
...
/*                                                                            */
/******************************************************************************/
real* cobweb_g_predictor::sendModelVar()
{
    return pp;
}
/******************************************************************************/
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::sendStateSpace(int &quantity,const real*** stateSpace)
{
    //cout << "cobweb_g_predictor sendStateSpace";
    if( *stateSpace )
	delete *stateSpace;
...
/*                                                                            */
/******************************************************************************/
real cobweb_g_predictor::hoch(real &x,int &i)
{
	real count=1.0;
	for (int k=i;k>0;k--)
		count*=x;
...
/*                                                                            */
/******************************************************************************/
real cobweb_g_predictor::fFunction(real &x)
{
	return (((a-3.0)/b) - (atan(alpha*(x-3.0))/b));
}
/******************************************************************************/
/*                                                                            */
/* Class name:      cobweb_g_predictor                                        */
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::dynamics(real &a)
{
	for (int i=1;i<=L;i++) 
		pp[L+1-i]=pp[L-i];
	pp[0]=fFunction(a);				
...
/*                                                                            */
/******************************************************************************/
void cobweb_g_predictor::iteration(const long& t)
{
	real add=0;
	real ev=0;
	real abw=0;
