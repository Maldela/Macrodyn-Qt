...
///////////////////////////////////////////////////////////////////////////////
qreal* finanzmarkt_gruppenswitch::setLabels(const QString& label)
{
    if (label == "R") return(&R);
    ...
    if (label == "return_f") return(&return_f);
    if (label == "return_n") return(&return_n);
    if (label == "mean_f") return(&mean_f);
    if (label == "mean_n") return(&mean_n);
    if (label == "variance_f") return(&variance_f);
    if (label == "variance_n") return(&variance_n);
    if (label == "U_f") return(&U_f);
    if (label == "U_n") return(&U_n);
...
//
///////////////////////////////////////////////////////////////////////////////
void finanzmarkt_gruppenswitch::loadParamset(QTextStream& inFile)
{
...
///////////////////////////////////////////////////////////////////////////////
void finanzmarkt_gruppenswitch::sendStateSpace(int &quantity,QList<qreal *> *stateSpace)
{
    stateSpace->clear();
...
///////////////////////////////////////////////////////////////////////////////
void finanzmarkt_gruppenswitch::iteration(const qint64& t)
{
log() << "epsilon=" << epsilon;
...
log() << "Periode:" << t;
log() << "mu:" << mu;
log() << "return_F:" << return_F;
log() << "return_N:" << return_N;
...
//////////mu = qMax{0,qMin{1,mu+epsilon*(return_f-return_n)}}//////////////////////////////
//
//
