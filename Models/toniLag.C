...
/*                                                                            */
/******************************************************************************/
void toniLag::loadParamset(QDataStream& inputFile)
{
...
/*                                                                            */
/******************************************************************************/
void toniLag::saveParamset(QDataStream& outputFile)
{
...
/*                                                                            */
/******************************************************************************/
void toniLag::saveParamsetWithNames(QDataStream& outputFile)
{
    outputFile << "\nModel ToniLag\n";
