...
/*                                                                            */
/******************************************************************************/
void toniadp2::loadParamset(QDataStream& inputFile)
{
...
/*                                                                            */
/******************************************************************************/
void toniadp2::saveParamset(QDataStream& outputFile)
{
...
/*                                                                            */
/******************************************************************************/
void toniadp2::saveParamsetWithNames(QDataStream& outputFile)
{
    outputFile << "\nModel Toniadp2\n";
