...
/*                                                                            */
/******************************************************************************/
void toniadp2::loadParamset(QTextStream& inputFile)
{
...
/*                                                                            */
/******************************************************************************/
void toniadp2::saveParamset(QTextStream& outputFile)
{
...
/*                                                                            */
/******************************************************************************/
void toniadp2::saveParamsetWithNames(QTextStream& outputFile)
{
    outputFile << "\nModel Toniadp2\n";
...
/*                                                                            */
/******************************************************************************/
void toniadp2::receiveParameters(const QList<qreal>& parameters)
{
    gamma=parameters[0];
    beta=parameters[1];
    alpha=parameters[2];
...
/*                                                                            */
/******************************************************************************/
qreal* toniadp2::setLabels(const QString& name)
{
    if (name == "xBundle")
	return &xBundle;
    if (name == "yBundle")
