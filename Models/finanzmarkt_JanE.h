...
protected:
    ...
    qreal beta;				//Einheitsparameter für Jobs ohne Bundleunterstützung
    qreal dummy;
    qreal etaC_us, etaC_os;			//Unter- und Oberschranke für eta_C
    ...
    qreal rho[L];				// Werte für MA Matrizen
    ...
    qreal var_F;						// uncentered second moment of returns fundamentalists
    ...
    qreal var_N;						// uncentered second moment of returns noise-traders
    ...
    qreal var_C;						// uncentered second moment of returns chartists
...
// Berechnungsfunktionen:
    ...
    qreal	sharpe_ratio2(qreal&, qreal&, qreal&);
