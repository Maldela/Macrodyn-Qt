...
m_l_attractor::m_l_attractor(baseModel* const bMod,const xyRange& axes,
                  MacrodynGraphicsItem* const graph, int psize, QString multiPlotLabel, qreal* ts_init_values)
                        : attractor(bMod,axes,graph)
{
    pointsize = psize;
