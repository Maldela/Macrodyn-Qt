...
class m_attractor : public geometricJob {
  public:
    qreal *zParam;
    qreal* multiplot_values;
    m_attractor(baseModel* const, const xyRange&, MacrodynGraphicsItem* const=NULL, QString multiPlotLabel=NULL, qreal* ts_init_values=NULL);
    void simulation();
};
