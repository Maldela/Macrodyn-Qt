...
class m_l_attractor : public attractor {
  public:
    int pointsize;


    m_l_attractor(baseModel* const, const xyRange&, MacrodynGraphicsItem* const=NULL, int psize=1, QString multiPlotLabel=NULL, qreal* ts_init_values=NULL);
     void simulation();
