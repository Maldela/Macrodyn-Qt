...
class m_density_1d : public geometricJob {
  protected:
    histo_1d	h;
    qreal        stepX;
    qreal        stepY;
  ...
  public:
    m_density_1d(baseModel* const, xyRange &, MacrodynGraphicsItem* const=NULL, QString multiPlotLabel=NULL, qreal* ts_init_values=NULL);
    void simulation();
};
