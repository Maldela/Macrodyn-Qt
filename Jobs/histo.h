...
public:
    ...
    histo_1d ( qreal x_min, qreal x_max, int x_res );
...
public:
    ...
    histo_2d ( qreal x_min, qreal x_max, int x_res,
...
public:
    ...
    histo_3d ( qreal x_min, qreal x_max, int x_res,
               qreal y_min, qreal y_max, int y_res,
	       qreal z_min, qreal z_max, int z_res );
